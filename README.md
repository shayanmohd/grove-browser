...
**Google sign-in is currently unsupported in this preview.** A live Play Console attempt was rejected by Google. Grove offers an explicit default-browser action for that page; it does not transfer the login back into Grove. See the [compatibility review](docs/review.md#google-sign-in-compatibility).
